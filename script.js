...
var array = ["blue", "red", "purple", "orange", "black", "cornsilk", "pink", "orange", "cornsilk"];array.forEach(function(thing)$(".element:first").clone().appendTo("#elements-list").css({backgroundColor: thing});});